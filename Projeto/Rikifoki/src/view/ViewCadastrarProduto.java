...
public class ViewCadastrarProduto extends JFrame {
	...
	public ViewCadastrarProduto() {
		...
		GravarButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					produto.setCustoLote(Double.parseDouble(textField_3.getText()));
					produto.setPrecoVenda(Double.parseDouble(textField_4.getText()));
					produto.setDescricao(textField_5.getText());
		...
		JLabel lblDescrioProduto = new JLabel("DESCRIÇÃO");
		lblDescrioProduto.setForeground(Color.LIGHT_GRAY);
		lblDescrioProduto.setFont(new Font("DialogInput", Font.PLAIN, 11));
		lblDescrioProduto.setBounds(10, 315, 100, 14);
		contentPane.add(lblDescrioProduto);
		
		textField_5 = new JTextField();
		textField_5.setColumns(10);
		textField_5.setBounds(119, 312, 355, 20);
		...
		btnEditar.setBounds(154, 417, 100, 34);
		contentPane.add(btnEditar);
	}
	
	public ViewCadastrarProduto(Produto p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 500, 501);
		contentPane = new JPanel();
		contentPane.setBackground(Color.DARK_GRAY);
		...
		contentPane.add(textField);
		textField.setColumns(10);
		textField.setText(Integer.toString(p.getReferencia()));
		
		textField_1 = new JTextField();
		textField_1.setBounds(120, 209, 354, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		textField_1.setText(Integer.toString(p.getQuantidade()));
		
		textField_2 = new JTextField();
		textField_2.setBounds(120, 234, 354, 20);
		contentPane.add(textField_2);
		textField_2.setColumns(10);
		textField_2.setText(Double.toString(p.getCustoUnit()));
		
		textField_3 = new JTextField();
		textField_3.setBounds(120, 259, 354, 20);
		contentPane.add(textField_3);
		textField_3.setColumns(10);
		textField_3.setText(Double.toString(p.getCustoLote()));
		
		textField_4 = new JTextField();
		textField_4.setBounds(119, 284, 355, 20);
		contentPane.add(textField_4);
		textField_4.setColumns(10);
		textField_4.setText(Double.toString(p.getPrecoVenda()));
		...
		textField_5.setBounds(119, 312, 355, 20);
		contentPane.add(textField_5);
		textField_5.setText(p.getDescricao());
